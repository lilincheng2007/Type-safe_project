...
export function fetchMerchantOrderChatMessagesIO(orderId: OrderId, peerRole: OrderChatRole): TaskIO<OrderChatMessagesResponse> {
  return sendAPI(new MerchantOrderChatMessagesAPI(orderId, peerRole))
}
