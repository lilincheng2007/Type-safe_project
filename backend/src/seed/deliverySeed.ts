...
export const seedOrders: Order[] = [
  {
    ...
    riderId: 'r-5001',
    items: [
      { productId: 'p-3001', name: '宫保鸡丁饭', unitPrice: 28, quantity: 1 },
      { productId: 'p-3002', name: '番茄牛腩饭', unitPrice: 32, quantity: 1 },
    ],
    totalAmount: 60,
  ...
  },
  {
    ...
    merchantId: 'm-2002',
    riderId: 'r-5002',
    items: [{ productId: 'p-3003', name: '杨枝甘露大杯', unitPrice: 22, quantity: 2 }],
    totalAmount: 44,
    deliveryAddress: '浦东新区世纪大道 100 号 1203 室',
    status: '已完成',
...
export const seedServiceAgents: CustomerServiceAgent[] = [
  {
    id: 'cs-01',
    name: '陈琳',
    department: '售后服务部',
...
export const seedOperationsManagers: OperationsManager[] = [
  {
    id: 'op-01',
    name: '吴越',
    region: '浦东新区',
...
export const seedMerchantApplications: MerchantApplication[] = [
  {
    id: 'ma-001',
    applicantName: '张晨',
    storeName: '夜猫子烧烤',
...
export const seedComplaintTickets: ComplaintTicket[] = [
  {
    id: 't-1',
    orderId: 'o-9001',
    customerName: '李然',
...
export const seedCampaigns: PromotionCampaign[] = [
  { id: 'c-01', title: '新客立减 12 元', target: '新客', status: '进行中' },
  { id: 'c-02', title: '周末全城满 39 减 6', target: '全体用户', status: '草稿' },
]
