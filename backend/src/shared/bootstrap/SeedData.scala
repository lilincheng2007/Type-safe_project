...
object SeedData:
  ...
  val seedProducts: List[Product] = List(
    Product("p-3001", "m-2001", "宫保鸡丁饭", 28, "经典川味，微辣。", "https://picsum.photos/200/120?food-1", 768, "充足", Some("会员价 25.5")),
    Product("p-3002", "m-2001", "番茄牛腩饭", 32, "慢炖牛腩，配时蔬。", "https://picsum.photos/200/120?food-2", 514, "紧张", None),
    Product("p-3003", "m-2002", "杨枝甘露大杯", 22, "芒果+西米+西柚，冰爽口感。", "https://picsum.photos/200/120?drink-1", 903, "充足", Some("第二杯半价"))
  )
  ...
  val seedOrders: List[Order] = List(
    Order("o-9001", "u-1001", "m-2001", Some("r-5001"), List(OrderItem("p-3001", "宫保鸡丁饭", 28, 1), OrderItem("p-3002", "番茄牛腩饭", 32, 1)), 60, "浦东新区世纪大道 100 号 1203 室", "配送中", "2026-03-29 11:42"),
    Order("o-9002", "u-1001", "m-2002", Some("r-5002"), List(OrderItem("p-3003", "杨枝甘露大杯", 22, 2)), 44, "浦东新区世纪大道 100 号 1203 室", "已完成", "2026-03-28 17:10")
  )
